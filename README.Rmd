...
```{r echo=FALSE,message=FALSE,fig.width=5,fig.height=5,fig.align='center',cache=TRUE,fig.cap="Screenshot showing the first six rows of the data used to generate the plots below.",fig.asp=0.40}
library(png)
library(grid)
