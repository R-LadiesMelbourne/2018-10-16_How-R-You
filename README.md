...
-   [Data visualisation via volcano plots](#data-visualisation-via-volcano-plots)
    -   [A typical data analysis pipeline](#a-typical-data-analysis-pipeline)
    -   [Drawing volcano plots with `ggplot2`](#drawing-volcano-plots-with-ggplot2)
...
<img src="README_files/figure-markdown_github/unnamed-chunk-18-1.png" alt="Figure 1. `geom_density_ridges()`"  />
<p class="caption">
Figure 1. `geom_density_ridges()`
</p>

<img src="README_files/figure-markdown_github/unnamed-chunk-19-1.png" alt="Figure 2. `geom_histogram() and `facet_wrap()``"  />
<p class="caption">
Figure 2. `geom_histogram() and`facet\_wrap()\`\`
</p>

<img src="README_files/figure-markdown_github/unnamed-chunk-20-1.png" alt="Figure 3. Another example of `geom_histogram() colouring by classes.`"  />
<p class="caption">
...
```
    ...
    ##  [1] ggrepel_0.8.0   bindrcpp_0.2.2  pheatmap_1.0.10 readxl_1.1.0   
    ##  [5] forcats_0.3.0   stringr_1.3.1   dplyr_0.7.6     purrr_0.2.5    
    ##  [9] readr_1.1.1     tidyr_0.8.1     tibble_1.4.2    tidyverse_1.2.1
    ## [13] reshape2_1.4.3  DT_0.4          ggplot2_3.0.0   icon_0.1.0     
    ## [17] emo_0.0.0.9000  png_0.1-7       magick_1.9     
    ## 
    ...
    ## [19] rstudioapi_0.7     rmarkdown_1.10     labeling_0.3      
    ## [22] htmlwidgets_1.2    munsell_0.5.0      shiny_1.1.0       
    ## [25] broom_0.5.0        compiler_3.5.1     httpuv_1.4.5      
    ## [28] modelr_0.1.2       pkgconfig_2.0.2    htmltools_0.3.6   
    ## [31] tidyselect_0.2.4   codetools_0.2-15   fansi_0.3.0       
    ## [34] crayon_1.3.4       withr_2.1.2        later_0.7.3       
    ## [37] nlme_3.1-137       jsonlite_1.5       xtable_1.8-2      
    ## [40] gtable_0.2.0       magrittr_1.5       scales_1.0.0      
    ## [43] cli_1.0.0          stringi_1.2.4      promises_1.0.1    
    ## [46] xml2_1.2.0         RColorBrewer_1.1-2 tools_3.5.1       
    ## [49] glue_1.3.0         hms_0.4.2          crosstalk_1.0.0   
    ## [52] yaml_2.2.0         colorspace_1.3-2   rvest_0.3.2       
    ## [55] knitr_1.20         bindr_0.1.1        haven_1.1.2
