...
```
    ...
    ##  [9] tidyr_0.8.1     tibble_1.4.2    tidyverse_1.2.1 reshape2_1.4.3 
    ## [13] DT_0.4          ggplot2_3.0.0   icon_0.1.0      emo_0.0.0.9000 
    ...
    ## [31] codetools_0.2-15   fansi_0.3.0        crayon_1.3.4      
    ## [34] withr_2.1.2        later_0.7.3        nlme_3.1-137      
    ## [37] jsonlite_1.5       xtable_1.8-2       gtable_0.2.0      
    ## [40] magrittr_1.5       scales_1.0.0       cli_1.0.0         
    ## [43] stringi_1.2.4      promises_1.0.1     xml2_1.2.0        
    ## [46] RColorBrewer_1.1-2 tools_3.5.1        glue_1.3.0        
